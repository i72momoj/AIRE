...
import org.i72momoj.aire.databinding.DialogEditTimerBinding
import org.i72momoj.aire.extensions.*
...
// MODIFICADO -> restore, layout
class EditTimerDialog(
    val activity: SimpleActivity,
    val timer: Timer,
    val restore: Boolean = true,
    val callback: (id: Long) -> Unit
) {
                ...
                activity.setupDialogStuff(binding.root, this) { alertDialog ->
                    alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener {
                        ...
                        activity.timerHelper.insertOrUpdateTimer(timer) {
                            ...
                            callback(it)
                            alertDialog.dismiss()
                            Log.d("EditTimerDialog", "ID del temporizador creado: ${timer.id}")
                        }
                    }
                }
            }
