...
import org.i72momoj.aire.activities.SnoozeReminderActivity
import org.i72momoj.aire.activities.SplashActivity
import org.i72momoj.aire.databases.AppDatabase
import org.i72momoj.aire.helpers.ALARM_ID
import org.i72momoj.aire.helpers.AlarmController
import org.i72momoj.aire.helpers.Config
import org.i72momoj.aire.helpers.DBHelper
import org.i72momoj.aire.helpers.EDITED_TIME_ZONE_SEPARATOR
import org.i72momoj.aire.helpers.FORMAT_12H
import org.i72momoj.aire.helpers.FORMAT_24H
import org.i72momoj.aire.helpers.MyAnalogueTimeWidgetProvider
import org.i72momoj.aire.helpers.MyDigitalTimeWidgetProvider
import org.i72momoj.aire.helpers.NOTIFICATION_ID
import org.i72momoj.aire.helpers.OPEN_ALARMS_TAB_INTENT_ID
import org.i72momoj.aire.helpers.OPEN_STOPWATCH_TAB_INTENT_ID
import org.i72momoj.aire.helpers.OPEN_TAB
...
import org.i72momoj.aire.helpers.UPCOMING_ALARM_INTENT_ID
import org.i72momoj.aire.helpers.formatTime
import org.i72momoj.aire.helpers.getAllTimeZones
import org.i72momoj.aire.helpers.getDefaultTimeZoneTitle
import org.i72momoj.aire.helpers.getTimeOfNextAlarm
...
import org.i72momoj.aire.receivers.AlarmReceiver
import org.i72momoj.aire.receivers.HideTimerReceiver
import org.i72momoj.aire.receivers.SkipUpcomingAlarmReceiver
import org.i72momoj.aire.receivers.StopAlarmReceiver
import org.i72momoj.aire.receivers.UpcomingAlarmReceiver
import org.i72momoj.aire.services.SnoozeService
...
fun Context.getTimerNotification(timer: Timer, pendingIntent: PendingIntent): Notification {
    ...
    timerHelper.insertOrUpdateTimer(
        Timer(
            id = timer.id,
        ...
        //timer.copy(channelId = channelId)
    )
