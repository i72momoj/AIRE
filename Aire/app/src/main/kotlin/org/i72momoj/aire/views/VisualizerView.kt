...
class VisualizerView(
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        // Hacemos una copia para evitar escrituras sobre la lista original mientras
        // esta está siendo recorrida, evitando una Android Runtime Exception
        val picosCopia = picos.toList()
