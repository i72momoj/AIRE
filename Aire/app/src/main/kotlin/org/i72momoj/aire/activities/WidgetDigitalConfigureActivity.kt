...
import org.i72momoj.aire.databinding.WidgetConfigDigitalBinding
...
import org.i72momoj.aire.helpers.SIMPLE_PHONE
...
class WidgetDigitalConfigureActivity : SimpleActivity() {
    ...
    private fun initVariables() {
        ...
        if (
            mTextColor == resources.getColor(R.color.default_widget_text_color)
            && isDynamicTheme()
        ) {
