...
const val TABS_COUNT = 3 // Antes era 4
...
// Los índices han sido modificados
const val TAB_CLOCK_INDEX = 1
...
const val STOPWATCH_TOGGLE_ACTION = "org.i72momoj.aire.TOGGLE_STOPWATCH"
...
const val EDITAR_ALARMA = 1
const val CONFIRMAR_CREACION = 2
const val CONFIRMAR_MODIFICACION = 4
const val CONFIRMAR_BORRADO = 8
const val CONFIRMAR_VOZ = 16

const val INSERTAR_O_ACTUALIZAR_ALARMA = 0
const val ELIMINAR_ALARMA = 1

const val TIPO_TEMPORIZADOR = 0
const val TIPO_ALARMA_CREAR = 1
const val TIPO_ALARMA_MODIFICAR = 2

const val TIPO_ALARMA_ACTIVAR = 3
const val TIPO_ALARMA_DESACTIVAR = 4
const val TIPO_ALARMA_BORRAR = 5


const val DATOS_ALARMA = 0
const val ALARMA_ACTUALIZADA = 1
